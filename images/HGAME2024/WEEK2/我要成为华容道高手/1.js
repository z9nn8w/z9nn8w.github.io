...
/***/ (function(module, exports, __webpack_require__) {
    ...
    */}
    ...
    var _Ground = __webpack_require__(17);
    ...
    exports.default = {
      components: { Ground: _Ground2.default, Board: _Board2.default },
      data: function data() {
        return {
          unitSize: window.innerHeight / 7,
          layout: "00000000000000000000",
          title: "开始游戏",
          gameId: 0
        };
      },
      ...
      methods: {
        handleMove: function handleMove(newLayout) {
          this.layout = newLayout;
        },
        handleSelect: function handleSelect() {
          var _this = this;
    
          fetch('/api/newgame').then(function (res) {
            return res.json();
          }).then(function (data) {
        ...
        handleSuccess: function handleSuccess(steps) {
          var _this2 = this;
      ...
      created: function created() {
        ...
        window.onresize = function () {
          return _this3.unitSize = window.innerWidth / 7;
        };
      }
    };
    ...
    exports.default = {
        ...
        computed: {
            ...
            points: function points() {
                ...
                return [unitSize * 0.5 + ',' + unitSize * 0.8, unitSize * 0.5 + ',' + unitSize * 5.8, unitSize * 1.5 + ',' + unitSize * 5.8, unitSize * 1.5 + ',' + unitSize * 6.3, unitSize * 3.5 + ',' + unitSize * 6.3, unitSize * 3.5 + ',' + unitSize * 5.8, unitSize * 4.5 + ',' + unitSize * 5.8, unitSize * 4.5 + ',' + unitSize * 0.8, unitSize * 0.5 + ',' + unitSize * 0.8].join(' ');
            }
        }
    };
    ...
    exports.default = {
      ...
      watch: {
        layout: function layout(newValue) {
          this.state = newValue;
        },
        state: function state(newVal) {
          this.$emit('change', newVal); // 当 state 发生变化时，打印新的值
        }
      },
      methods: {
    ...
    exports.default = {
      ...
      watch: {
        startX: function startX(newValue) {
          this.x = newValue;
        },
        startY: function startY(newValue) {
          this.y = newValue;
        }
      },
      computed: {
      ...
      methods: {
        ...
        handleTouchMove: function handleTouchMove(e) {
          ...
          var shiftX = this.x - this.startX;
          var shiftY = this.y - this.startY;
          var direction = 0;
          if (Math.abs(shiftY) > Math.abs(shiftX)) {
            if (-shiftY > this.unitSize / 1.5) direction = 1;else if (shiftY > this.unitSize / 1.5) direction = 3;
          } else {
            if (shiftX > this.unitSize / 1.5) direction = 2;else if (-shiftX > this.unitSize / 1.5) direction = 4;
          }
        ...
        handleTouchEnd: function handleTouchEnd(e) {
          ...
          var _this = this,
              step = 5;
          var distanceX = _this.x - this.startX;
          var distanceY = _this.y - this.startY;
          var inv = setInterval(function () {
            if (! --step) {
              clearInterval(inv);
              _this.draging = false;
            }
            _this.x = _this2.startX + distanceX * step * 0.1;
            _this.y = _this2.startY + distanceY * step * 0.1;
          }, 10);
        },
    ...
    ***************************************************************************** */
        ...
        if (!isPlainObject(target)) {
            if (process.env.NODE_ENV !== 'production') {
                if (isArray(target)) {
                    ...
                    warn("value cannot be made readonly: ".concat(typeof target === 'undefined' ? 'undefined' : _typeof(target)));
                }
            }
            return target;
        }
    ...
    function watchPostEffect(effect, options) {
        return doWatch(effect, null, process.env.NODE_ENV !== 'production' ? _assign(_assign({}, options), { flush: 'post' }) : { flush: 'post' });
    }
    function watchSyncEffect(effect, options) {
        return doWatch(effect, null, process.env.NODE_ENV !== 'production' ? _assign(_assign({}, options), { flush: 'sync' }) : { flush: 'sync' });
    }
    ...
    function normalizeScopedSlot(vm, normalSlots, key, fn) {
        var normalized = function normalized() {
            ...
            res = res && (typeof res === 'undefined' ? 'undefined' : _typeof(res)) === 'object' && !isArray(res) ? [res] // single vnode
    ...
    function initSetup(vm) {
        ...
        if (setup) {
            ...
            if (isFunction(setupResult)) {
                ...
                warn("setup() should return an object. Received: ".concat(setupResult === null ? 'null' : typeof setupResult === 'undefined' ? 'undefined' : _typeof(setupResult)));
            }
        }
    }
    ...
    function registerRef(vnode, isRemoval) {
        ...
        if (_isString || _isRef) {
            if (isFor) {
                ...
                warn("Invalid template ref type: ".concat(typeof ref === 'undefined' ? 'undefined' : _typeof(ref)));
            }
        }
    }
    ...
    /* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(3), __webpack_require__(11).setImmediate))
    ...
    var update = __webpack_require__(1)("b0cefc10", content, false, {});
    ...
    "use strict";
    Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue__ = __webpack_require__(6);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue__);
    /* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_46214b1c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Ground_vue__ = __webpack_require__(20);
    var disposed = false
    function injectStyle (ssrContext) {
      if (disposed) return
    ...
    var __vue_module_identifier__ = null
    var Component = normalizeComponent(
      __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Ground_vue___default.a,
      __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_46214b1c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Ground_vue__["a" /* default */],
      __vue_template_functional__,
      __vue_styles__,
      __vue_scopeId__,
      __vue_module_identifier__
    )
    Component.options.__file = "src/Component/Ground.vue"
    ...
    if (false) {(function () {
      ...
      module.hot.accept()
      if (!module.hot.data) {
        hotAPI.createRecord("data-v-46214b1c", Component.options)
      } else {
        hotAPI.reload("data-v-46214b1c", Component.options)
      }
      module.hot.dispose(function (data) {
        disposed = true
      })
    ...
    if(content.locals) module.exports = content.locals;
    // add the styles to the DOM
    var update = __webpack_require__(1)("7f0f2613", content, false, {});
    // Hot Module Replacement
    if(false) {
     // When the styles change, update the <style> tags
     if(!content.locals) {
       module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-46214b1c\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Ground.vue", function() {
         var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-46214b1c\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Ground.vue");
         if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
         update(newContent);
       });
     }
    ...
    var render = function() {
      ...
      return _c(
        "svg",
        { staticClass: "ground", attrs: { width: _vm.width, height: _vm.height } },
        [
          _c("rect", {
            attrs: { x: "0", y: "0", width: _vm.width, height: _vm.height }
          }),
          _vm._v(" "),
    ...
    if (false) {
      module.hot.accept()
      if (module.hot.data) {
        require("vue-hot-reload-api")      .rerender("data-v-46214b1c", esExports)
      }
    }
    ...
    "use strict";
    Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Board_vue__ = __webpack_require__(7);
    ...
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1892ce4b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Board_vue__ = __webpack_require__(29);
    var disposed = false
    function injectStyle (ssrContext) {
      if (disposed) return
    ...
    var Component = normalizeComponent(
      ...
      __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1892ce4b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Board_vue__["a" /* default */],
      __vue_template_functional__,
      __vue_styles__,
      __vue_scopeId__,
      __vue_module_identifier__
    )
    Component.options.__file = "src/Component/Board.vue"
    ...
    if (false) {(function () {
      ...
      module.hot.accept()
      if (!module.hot.data) {
        hotAPI.createRecord("data-v-1892ce4b", Component.options)
      } else {
        hotAPI.reload("data-v-1892ce4b", Component.options)
      }
      module.hot.dispose(function (data) {
        disposed = true
      })
    ...
    if(content.locals) module.exports = content.locals;
    // add the styles to the DOM
    var update = __webpack_require__(1)("0d16783c", content, false, {});
    // Hot Module Replacement
    if(false) {
     // When the styles change, update the <style> tags
     if(!content.locals) {
       module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1892ce4b\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Board.vue", function() {
         var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1892ce4b\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Board.vue");
         if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
         update(newContent);
       });
     }
    ...
    "use strict";
    Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Grid_vue__ = __webpack_require__(8);
    ...
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a929251e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Grid_vue__ = __webpack_require__(27);
    var disposed = false
    function injectStyle (ssrContext) {
      if (disposed) return
    ...
    var Component = normalizeComponent(
      ...
      __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a929251e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Grid_vue__["a" /* default */],
      __vue_template_functional__,
      __vue_styles__,
      __vue_scopeId__,
      __vue_module_identifier__
    )
    Component.options.__file = "src/Component/Grid.vue"
    ...
    if (false) {(function () {
      ...
      module.hot.accept()
      if (!module.hot.data) {
        hotAPI.createRecord("data-v-a929251e", Component.options)
      } else {
        hotAPI.reload("data-v-a929251e", Component.options)
      }
      module.hot.dispose(function (data) {
        disposed = true
      })
    ...
    if(content.locals) module.exports = content.locals;
    // add the styles to the DOM
    var update = __webpack_require__(1)("839ade04", content, false, {});
    // Hot Module Replacement
    if(false) {
     // When the styles change, update the <style> tags
     if(!content.locals) {
       module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a929251e\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Grid.vue", function() {
         var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a929251e\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/less-loader/dist/cjs.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Grid.vue");
         if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
         update(newContent);
       });
     }
    ...
    var render = function() {
      ...
      return _c("svg", [
        _c(
          ...
          [
            _c(
              ...
              [
                _c("stop", {
                  staticStyle: { "stop-color": "#ffffff", "stop-opacity": "0.7" },
                  attrs: { offset: "0%" }
                }),
                _vm._v(" "),
                _c("stop", {
                  staticStyle: { "stop-color": "#000000", "stop-opacity": "0.3" },
                  attrs: { offset: "100%" }
                })
              ],
              1
        ...
        _c("rect", {
          staticClass: "grid",
          class: { success: _vm.success },
          attrs: {
            filter: "url(#depthShadow)",
            id: _vm.draging && "draging",
            x: _vm.x,
            y: _vm.y,
            width: _vm.width,
            height: _vm.height,
    ...
    if (false) {
      module.hot.accept()
      if (module.hot.data) {
        require("vue-hot-reload-api")      .rerender("data-v-a929251e", esExports)
      }
    }
    ...
    var Queue = function (_Array) {
        ...
        function Queue(size) {
            ...
            var _this2 = _possibleConstructorReturn(this, (Queue.__proto__ || Object.getPrototypeOf(Queue)).call(this));
    
            _this2.front = _this2.tail = 0;
            _this2.fullFlag = false;
            _this2.size = size || 1048576;
            return _this2;
        }
        ...
        _createClass(Queue, [{
            ...
            value: function push(data) {
                if (this.fullFlag) throw new Error('Can not push a value into a full queue!');
                this[this.tail++] = data;
            ...
            value: function shift() {
                if (this.front === this.tail && !this.fullFlag) throw new Error('Can not shift a value from a empty queue!');
                var ret = this[this.front++];
    ...
    var render = function() {
      ...
      return _c(
        ...
        [
            ...
            return t !== "1" && t !== "0"
              ? _c("Grid", {
                  ...
                  attrs: {
                    type: t,
                    position: i,
                    success: t === "5" && _vm.success,
                    unitSize: _vm.unitSize,
                    startX: (i % 4) * _vm.unitSize,
                    startY: Math.floor(i / 4) * _vm.unitSize,
          ...
          _vm._v(" "),
          _c("use", { attrs: { "xlink:href": "#draging" } })
        ],
        2
      )
    }
    ...
    if (false) {
      module.hot.accept()
      if (module.hot.data) {
        require("vue-hot-reload-api")      .rerender("data-v-1892ce4b", esExports)
      }
    }
      ...
      return _c(
        ...
        [
          _c("Ground", {
            ...
            attrs: { unitSize: _vm.unitSize }
          }),
          _vm._v(" "),
          _c("Board", {
            style: {
              position: "absolute",
              top: _vm.unitSize * 0.8,
              left: _vm.unitSize * 0.5
            },
            attrs: { unitSize: _vm.unitSize, layout: _vm.layout },
            on: { success: _vm.handleSuccess, change: _vm.handleMove }
          }),
          _vm._v(" "),
          _c(
            "div",
            {
              ...
              style: {
                top: (_vm.unitSize * 0.8 - 34) / 2 + "px",
                left: (_vm.unitSize * 5 - 124) / 2 + "px"
              },
